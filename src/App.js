...
import UsersLayout, { loader as usersLoader } from './routes/users/layout'
  ...
  return (
    <DataBrowserRouter>
      <Route path="/" element={<Layout />} id="root">
        <Route path="/users" element={<UsersLayout />} loader={usersLoader} id="Users" errorElement={<ErrorBoundary />}>
